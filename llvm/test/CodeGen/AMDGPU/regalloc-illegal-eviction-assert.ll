...
; RUN: not --crash llc -mtriple=amdgcn -mcpu=gfx908 -verify-machineinstrs %s -o /dev/null 2>&1 | FileCheck -check-prefixes=ERR,VERIFIER %s
...
; Please refer [regalloc-failure-overlapping-insert-assert.mir]. The cause
; for machine verifier failure explained there is similar to this. Before
; it was hidden due to implicit usage of superregs.
